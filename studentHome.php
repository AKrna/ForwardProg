	...
	<body>
		...
		<div class="container">
			<ul class="tabs">
				...
				<li><a href="javascript:void(0)" class="tabLink" onclick="openPage(event,\'EditInformation\')">Student Profile</a></li>
				<li><a href="javascript:void(0)" class="tabLink" onclick="openPage(event,\'ReportInternship/Job\')">Report Internship/Job</a></li>
				<li><a href="javascript:void(0)" class="tabLink" onclick="openPage(event,\'ViewListedInternshipsJobs\')">View or Add an Internship</a></li>
			</ul>
